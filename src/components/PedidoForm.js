...
const PedidoForm = ({ onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="card shadow-sm p-4 mb-4 border-0 rounded-4 bg-light">
      ...
      {/* Título */}
      <div className="mb-3">
        <label htmlFor="titulo" className="form-label fw-semibold d-flex align-items-center gap-2">
          <FiEdit2 /> Título
        </label>
        <input
          type="text"
      ...
      {/* Descrição */}
      <div className="mb-3">
        <label htmlFor="descricao" className="form-label fw-semibold d-flex align-items-center gap-2">
      ...
      {/* Validade */}
      <div className="mb-4">
        <label htmlFor="validade_orcamentos" className="form-label fw-semibold d-flex align-items-center gap-2">
